...
This system was originally built to evaluate 740+ job offers, generate 100+ tailored CVs, and land a Head of Applied AI role. The archetypes, scoring logic, negotiation scripts, and proof point structure are all customizable to fit any career search.

**It works out of the box, and it's designed to be made yours.** If the archetypes don't match your career, the modes are in the wrong language, or the scoring doesn't fit your priorities -- just ask. You (Claude) can edit any file in this system. The user says "change the archetypes to data engineering roles" and you do it. That's the whole point.
...
>
> Tip: Having a personal portfolio dramatically improves your job search. Consider building one to showcase alongside your job applications."
